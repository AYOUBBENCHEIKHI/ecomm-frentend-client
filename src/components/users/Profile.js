...
const Profile = () => {
  return (
    <div class="ml-10 py-20 bg-white dark:bg-white flex flex-wrap items-center justify-center">
  <div class="container max-w-lg bg-white rounded dark:bg-gray-800 shadow-lg transform duration-200 easy-in-out m-12">
    <div class="flex justify-start px-5 mt-0 mb-5">
    ...
    <div class="">
      <div class="px-7 mb-8">
        ...
        <p class="text-gray-400 mt-2 dark:text-gray-400"></p>
        <p class="mt-2 text-gray-600 dark:text-gray-300">ayoub@test.com</p>
        <div
        ...
        <div class="flex flex-wrap justify-center gap-2 sm:gap-4 mt-8">
          ...
          <button
            class="text-green-900 hover:text-green-700 p-1 sm:p-2  inline-flex items-center dark:hover:text-gray-30 dark:text-gray-400 dark:hover:text-gray-300">
            <svg class="w-7 h-7 fill-current" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path
